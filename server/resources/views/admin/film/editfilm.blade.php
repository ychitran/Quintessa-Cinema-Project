            ...
            <div class="card-body">
              <form action="" method="POST" class="form-horizontal">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input id="inputHorizontalSuccess" name="film_name" type="text" placeholder="Tên phim" value="{{$film->film_name}}" class="form-control form-control-success ">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input id="inputHorizontalWarning" name="poster" type="file" value="" class="form-control form-control-warning ">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input id="inputHorizontalWarning" name="caster" type="text" placeholder="Diễn viên" value="{{$film->caster}}" class="form-control form-control-warning ">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-3 form-control-label">Thời lượng</label>
                  <div class="col-md-9">
                    <input id="inputHorizontalWarning" name="duration" type="text" placeholder="Thời lượng" value="{{$film->duration}}" class="form-control form-control-warning ">
                  </div>
                </div>
                <div class="form-group row">
